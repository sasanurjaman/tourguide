<div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="update" class="g-3 needs-validation" novalidate>
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $article_imageOld) }}" alt="" id="preview"
    ...
    <script>
        const toolbarOptions = [
            ...
            const input = document.querySelector("#input_descrition");
            ...
            quill.root.innerHTML = {!! json_encode($article_description) !!};
    </script>
    @endpush
</div>